...
# 'download_utils', 'drawing_styles', 'drawing_utils', 
# 'face_detection', 'face_mesh', 'face_mesh_connections', 
# 'hands', 'hands_connections', 'holistic', 'mediapipe', 
# 'objectron', 'pose', 'pose_connections', 'selfie_segmentation']

# For static images:

IMAGE_FILES = ['Dataset/Train/img/99.png']
...
with mp_face_mesh.FaceMesh(
  ...
  for idx, file in enumerate(IMAGE_FILES):
    ...
    for face_landmarks in results.multi_face_landmarks:      
      center = face_landmarks.landmark[0] # normalized nose pos
      print (len(face_landmarks.landmark))
      # center = face_landmarks[0] # normalized 
      print('face_center :' )
      features = np.asarray(face_landmarks.landmark)
